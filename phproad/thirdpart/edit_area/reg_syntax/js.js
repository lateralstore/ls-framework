editAreaLoader.load_syntax["js"] = {
	...
	,'STYLES' : {
		'COMMENTS': 'color: #1673ff;'
		,'QUOTESMARKS': 'color: #036a07;'
		,'KEYWORDS' : {
			'statements' : 'color: #4444ff;'
			,'keywords' : 'color: #4444ff;'
			,'functions' : 'color: #2f2fb2;'
		}
		,'OPERATORS' : 'color: #687687;'
		,'DELIMITERS' : 'color: #232323;'
